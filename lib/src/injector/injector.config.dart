...
import 'package:elearning/src/domain/repositories/payment_repository.dart'
    as _i24;
import 'package:elearning/src/module/register_module.dart' as _i33;
import 'package:elearning/src/presentation/bloc/bloc/detail_course_bloc.dart'
    as _i28;
import 'package:elearning/src/presentation/bloc/clock/clock_bloc.dart' as _i26;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i23.PaymentApiService>(
        () => registerModule.paymentApiService(
              gh<_i3.Dio>(instanceName: 'apiDio'),
              gh<String>(instanceName: 'apiBaseUrl'),
            ));
    gh.lazySingleton<_i24.PaymentRepository>(
        () => _i25.PaymentRepositoryImpl(gh<_i23.PaymentApiService>()));
    gh.factory<_i26.ClockBloc>(() => _i26.ClockBloc(gh<_i6.ClockRepository>()));
    gh.factory<_i27.CourseBloc>(
        () => _i27.CourseBloc(gh<_i9.CourseRepository>()));
    gh.factory<_i28.DetailCourseBloc>(
        () => _i28.DetailCourseBloc(gh<_i12.DetailCourseRepository>()));
    gh.factory<_i29.HomeBloc>(() => _i29.HomeBloc(gh<_i15.HomeRepository>()));
    gh.factory<_i30.MessageBloc>(
        () => _i30.MessageBloc(gh<_i18.MessageRepository>()));
    gh.factory<_i31.NotificationBloc>(
        () => _i31.NotificationBloc(gh<_i21.NotificationRepository>()));
    gh.factory<_i32.PaymentBloc>(
        () => _i32.PaymentBloc(gh<_i24.PaymentRepository>()));
    return this;
  }
}
